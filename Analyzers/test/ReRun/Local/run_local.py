...
#process.source.lumisToProcess = LumiList.LumiList(filename = '/u/user/msoh/MuonHLT/RateStudy2017/CMSSW_9_2_6/src/MuonHLTNtuples/Analyzers/test/JSON/DCSOnly/json_DCSONLY.txt').getVLuminosityBlockRange()
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("muonNtuple_TEST.root"),

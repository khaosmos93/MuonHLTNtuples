# hltGetConfiguration orcoff:/cdaq/physics/Run2017/2e34/v3.2.2/HLT/V6 --path HLTriggerFirstPath,HLT_IsoMu27_v*,HLT_Mu50_v*,HLT_OldMu100_v*,HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v*,HLTriggerFinalPath,HLTAnalyzerEndpath --input file:/u/user/msoh/MuonHLT/RateStudy2017_v3/TestSample/W/AOD/B09BB770-649D-E711-A46E-0CC47AD98BC2.root --parent file:/u/user/msoh/MuonHLT/RateStudy2017_v3/TestSample/FIXME/RAW/FIXME --full --offline --mc --unprescale --process MSHLT --globaltag 92X_upgrade2017_realistic_v12 --output none --max-events 1000

# /cdaq/physics/Run2017/2e34/v3.2.2/HLT/V6 (CMSSW_9_2_10)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2017/2e34/v3.2.2/HLT/V6')
)
...
process.datasets = cms.PSet(
  ...
  OnlineMonitor = ( cms.vstring( 'HLT_AK4CaloJet100_v9',
    ...
    'HLT_IsoMu24_eta2p1_MediumChargedIsoPFTau20_SingleL1_v8')+cms.vstring( 'HLT_IsoMu24_eta2p1_MediumChargedIsoPFTau20_TightID_SingleL1_v8',
...
process.HLT_IsoMu27_v13 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu22or25 + process.hltPreIsoMu27 + process.hltL1fL1sMu22or25L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2fL1sMu22or25L1f0L2Filtered10Q) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3L1fL1sMu22or25L1Filtered0) + process.hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27Q + process.HLTMu27IsolationSequence + process.hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p07 + process.HLTEndSequence )
process.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sDoubleMu125to157 + process.hltPreMu17TrkIsoVVLMu8TrkIsoVVLDZMass3p8 + process.hltL1fL1sDoubleMu155L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2pfL1sDoubleMu155L1f0L2PreFiltered0) + cms.ignore(process.hltL2fL1sDoubleMu155L1f0L2Filtered10OneMu) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3L1fL1sDoubleMu155L1Filtered0) + process.hltL3fL1DoubleMu155fPreFiltered8 + process.hltL3fL1DoubleMu155fFiltered17 + process.HLTL3muontrkisovvlSequence + process.hltDiMuon178RelTrkIsoFiltered0p4 + process.hltDiMuon178RelTrkIsoFiltered0p4DzFiltered0p2 + process.hltDiMuon178Mass3p8Filtered + process.HLTEndSequence )
process.HLT_Mu50_v11 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu22or25 + process.hltPreMu50 + process.hltL1fL1sMu22or25L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2fL1sMu22or25L1f0L2Filtered10Q) + process.HLTL3muonrecoSequence + cms.ignore(process.hltL1fForIterL3L1fL1sMu22or25L1Filtered0) + process.hltL3fL1sMu22Or25L1f0L2f10QL3Filtered50Q + process.HLTEndSequence )
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string("muonNtuple_W_v3p2.root"),
...
process.source = cms.Source( "PoolSource",
    ...
    lumisToProcess = cms.untracked.VLuminosityBlockRange('1:377-1:378'),

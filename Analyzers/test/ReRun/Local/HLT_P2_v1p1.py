# hltGetConfiguration orcoff:/cdaq/physics/Run2017/2e34/v1.1.1/HLT/V2 --path HLTriggerFirstPath,HLT_IsoMu27_v*,HLT_Mu50_v*,HLT_OldMu100_v*,HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v*,HLTriggerFinalPath,HLTAnalyzerEndpath --input file:/u/user/msoh/MuonHLT/RateStudy2017_v3/TestSample/FIXME/AOD/FIXME --parent file:/u/user/msoh/MuonHLT/RateStudy2017_v3/TestSample/FIXME/RAW/FIXME --full --offline --mc --unprescale --process MSHLT --globaltag 92X_upgrade2017_realistic_v12 --output none --max-events 1000

# /cdaq/physics/Run2017/2e34/v1.1.1/HLT/V2 (CMSSW_9_2_2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2017/2e34/v1.1.1/HLT/V2')
)
...
process.datasets = cms.PSet(
  ...
  BTagCSV = cms.vstring( 'HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07_v2',
  ...
  JetHT = cms.vstring( 'HLT_AK8PFJet140_v5',
    'HLT_AK8PFJet200_v5',
    'HLT_AK8PFJet260_v6',
    'HLT_AK8PFJet320_v6',
    'HLT_AK8PFJet400_v6',
  ...
  MuOnia = cms.vstring( 'HLT_Dimuon12_Upsilon_eta1p5_v8',
...
process.HLT_IsoMu27_v8 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu22or25 + process.hltPreIsoMu27 + process.hltL1fL1sMu22or25L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2fL1sMu22or25L1f0L2Filtered10Q) + process.HLTL3muonrecoSequence + process.hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27Q + process.HLTMu27IsolationSequence + process.hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p07 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_IsoMu27_v8, process.HLT_Mu50_v6, process.HLTriggerFinalPath ))
...
outputName = "muonNtuple_ttbar_P2_v1p1.root"

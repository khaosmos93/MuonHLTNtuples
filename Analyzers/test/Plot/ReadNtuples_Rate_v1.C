...
void ReadNtuples_Rate_v1(TString Menu, std::string hltname, bool verbose) {
  TTimeStamp ts_start;
  ...
  TString outputDir = "outputs/Rate_v1";
  ...
  TString outputPath = outputDir+"/Rate_v1_"+Menu+"_"+hltname+"_"+theDate+".root";

# hltGetConfiguration orcoff:/cdaq/physics/Run2017/2e34/v1.2.1/HLT/V1 --path HLTriggerFirstPath,HLT_IsoMu27_v*,HLT_Mu50_v*,HLT_OldMu100_v*,HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v*,HLTriggerFinalPath,HLTAnalyzerEndpath --input file:/u/user/msoh/MuonHLT/RateStudy2017_v3/TestSample/FIXME/AOD/FIXME --parent file:/u/user/msoh/MuonHLT/RateStudy2017_v3/TestSample/FIXME/RAW/FIXME --full --offline --mc --unprescale --process MSHLT --globaltag 92X_upgrade2017_realistic_v12 --output none --max-events 1000

# /cdaq/physics/Run2017/2e34/v1.2.1/HLT/V1 (CMSSW_9_2_2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2017/2e34/v1.2.1/HLT/V1')
)
...
process.streams = cms.PSet(
  ...
  PhysicsZeroBias2 = cms.vstring( 'ZeroBias5',
    'ZeroBias6',
    'ZeroBias7' ),
  PhysicsZeroBias3 = cms.vstring( 'ZeroBias10',
    'ZeroBias8',
    'ZeroBias9' ),
...
process.datasets = cms.PSet(
  ...
  BTagCSV = cms.vstring( 'HLT_HT300PT30_QuadJet_75_60_45_40_TripeCSV_p07_v3',
  ...
  Charmonium = cms.vstring( 'HLT_Dimuon0_LowMass_L1_0er1p5R_v2',
  ...
  ExpressAlignment = cms.vstring( 'HLT_HT300_Beamspot_v2',
    'HLT_HT450_Beamspot_v2' ),
  ExpressPhysics = cms.vstring( 'HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v12',
    'HLT_IsoMu20_v9',
    'HLT_IsoMu24_v7',
    'HLT_IsoMu27_v10',
    'HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v10',
  ...
  HINPFJets = cms.vstring( 'HLT_AK4PFJet100_v10',
    ...
    'HLT_AK4PFJet50_v10',
    'HLT_AK4PFJet80_v10' ),
  HLTMonitor = cms.vstring( 'HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v12',
  ...
  JetHT = cms.vstring( 'HLT_AK8PFJet140_v6',
    'HLT_AK8PFJet200_v6',
    'HLT_AK8PFJet260_v7',
    'HLT_AK8PFJet320_v7',
    'HLT_AK8PFJet400_v7',
  ...
  MET = cms.vstring( 'HLT_MonoCentralPFJet80_PFMETNoMu110_PFMHTNoMu110_IDTight_v11',
  ...
  MuOnia = cms.vstring( 'HLT_Dimuon12_Upsilon_eta1p5_v9',
  ...
  MuonEG = cms.vstring( 'HLT_DiMu9_Ele9_CaloIdL_TrackIdL_DZ_v10',
  ...
  SingleElectron = cms.vstring( 'HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTau30_eta2p1_CrossL1_v4',
    'HLT_Ele24_eta2p1_WPTight_Gsf_LooseChargedIsoPFTau30_eta2p1_TightID_CrossL1_v4',
    'HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTau30_eta2p1_CrossL1_v4',
    'HLT_Ele24_eta2p1_WPTight_Gsf_MediumChargedIsoPFTau30_eta2p1_TightID_CrossL1_v4',
    'HLT_Ele24_eta2p1_WPTight_Gsf_TightChargedIsoPFTau30_eta2p1_CrossL1_v4',
...
process.hltL3fL1sMu22Or25L1f0L2f10QL3Filtered50Q = cms.EDFilter( "HLTMuonTrkL1TFilter",
    maxNormalizedChi2 = cms.double( 1.0E99 ),
    saveTags = cms.bool( True ),
    maxAbsEta = cms.double( 1.0E99 ),
    previousCandTag = cms.InputTag( "hltL1fL1sMu22or25L1Filtered0" ),
...
process.HLT_IsoMu27_v10 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu22or25 + process.hltPreIsoMu27 + process.hltL1fL1sMu22or25L1Filtered0 + process.HLTL2muonrecoSequence + cms.ignore(process.hltL2fL1sMu22or25L1f0L2Filtered10Q) + process.HLTL3muonrecoSequence + process.hltL3fL1sMu22Or25L1f0L2f10QL3Filtered27Q + process.HLTMu27IsolationSequence + process.hltL3crIsoL1sMu22Or25L1f0L2f10QL3f27QL3trkIsoFiltered0p07 + process.HLTEndSequence )
process.HLT_Mu50_v8 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu22or25 + process.hltPreMu50 + process.hltL1fL1sMu22or25L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu22or25L1f0L2Filtered10Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu22Or25L1f0L2f10QL3Filtered50Q + process.HLTEndSequence )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_IsoMu27_v10, process.HLT_Mu50_v8, process.HLTriggerFinalPath ))
